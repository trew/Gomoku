...
public class Button extends InputAdapter
{
  ...
  public Button(String text, Font font, Image backgroundImage, int x, int y)
  {
    ...
    textHeightPadding = 5;
    textWidthPadding = 10;
    constructorHack(text,
                    backgroundImage,
                    null,
                    null,
                    null,
                    new Rectangle(x, y, textWidth + textWidthPadding * 2, textHeight + textHeightPadding * 2));
  }
  ...
  public Button(Image button, Image buttonHover, Image buttonClick, Image buttonDisabled, int x, int y)
  {
    if (button == null)
    {
   ...
   */
  private void constructorHack(String text, Image button, Image hover, Image click, Image disabled, Rectangle area)
  {
    this.area = area;
    this.text = text;
  ...
  public void render(GUIContext container, Graphics g) throws SlickException
  {
    ...
    if (text != null)
    {
      font.drawString(area.getX() + textWidthPadding, area.getY() + textHeightPadding + textYModifier, text);
    }
